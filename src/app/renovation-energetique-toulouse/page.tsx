...
export const metadata: Metadata = {
  ...
  description:
    "Spécialiste rénovation énergétique Toulouse. Isolation, PAC, menuiseries, VMC. Montage aides MaPrimeRénov' jusqu'à 20k€, Éco-PTZ 50k€, CEE. DPE G→B garanti. Devis gratuit 48h. ROI 8-12 ans.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Expert rénovation énergétique Toulouse. Isolation, PAC, DPE G→B. Aides jusqu'à 20k€ gérées. Devis gratuit.",
        ...
        <div className="container">
          <div className="max-w-4xl">
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-stone-200">
              <div>
                <div className="text-3xl font-light text-stone-900 mb-2">-65%</div>
                <div className="text-sm text-stone-600">Factures énergie</div>
              </div>
              <div>
                <div className="text-3xl font-light text-stone-900 mb-2">20k€</div>
                <div className="text-sm text-stone-600">Aides MaPrimeRénov'</div>
              </div>
              <div>
                <div className="text-3xl font-light text-stone-900 mb-2">8-12 ans</div>
                <div className="text-sm text-stone-600">ROI moyen</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg prose-stone max-w-none">
              ...
              <div className="space-y-6 mb-12">
                {/* MaPrimeRénov' */}
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 border-2 border-blue-200 p-8 rounded">
                  ...
                  <div className="space-y-4 text-stone-700">
                    ...
                    <div className="bg-white p-5 rounded">
                      <h4 className="font-semibold text-stone-900 mb-3">Montants par poste de travaux (ménages modestes - Jaune):</h4>
                      ...
                      <p className="text-xs text-stone-600 mt-3">Plafond total: 20 000€ sur 5 ans par logement</p>
                    </div>
                ...
                <div className="bg-gradient-to-r from-green-50 to-green-100 border-2 border-green-200 p-8 rounded">
                  <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="space-y-4 text-stone-700">
                    ...
                    <div className="bg-white p-5 rounded">
                      <h4 className="font-semibold text-stone-900 mb-3">Taux de prise en charge:</h4>
                      <div className="space-y-3">
                        <div>
                          ...
                          <div className="text-sm text-stone-600">Plafond 35 000€ (soit 70 000€ de travaux max)</div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="text-sm text-stone-600">Plafond 21 000€ (soit 60 000€ de travaux max)</div>
                        </div>
                      </div>
                    </div>
                ...
                {/* Éco-PTZ */}
                <div className="bg-gradient-to-r from-purple-50 to-purple-100 border-2 border-purple-200 p-8 rounded">
                  <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="space-y-4 text-stone-700">
                    ...
                    <div className="bg-white p-5 rounded">
                      <h4 className="font-semibold text-stone-900 mb-3">Montants selon nombre de travaux:</h4>
                ...
                {/* CEE */}
                <div className="bg-gradient-to-r from-orange-50 to-orange-100 border-2 border-orange-200 p-8 rounded">
                  <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="space-y-4 text-stone-700">
                    ...
                    <div className="bg-white p-5 rounded">
                      <h4 className="font-semibold text-stone-900 mb-3">Montants indicatifs Toulouse (2025):</h4>
                      <ul className="space-y-2 text-sm">
              ...
              <div className="bg-stone-900 text-white p-8 rounded-lg">
                ...
                <div className="space-y-3 text-base">
                  <div className="flex justify-between pb-3 border-b border-stone-700">
                    <span className="text-stone-300">Coût total travaux HT</span>
                    <strong className="text-2xl">55 000€</strong>
                  </div>
                  <div className="flex justify-between pb-2">
                    <span className="text-stone-400">- MaPrimeRénov' Sérénité (35%)</span>
                    <strong className="text-green-400">- 19 250€</strong>
                  </div>
                  <div className="flex justify-between pb-2">
                    <span className="text-stone-400">- CEE primes énergie</span>
                    <strong className="text-green-400">- 4 200€</strong>
                  </div>
                  <div className="flex justify-between pb-2">
                    <span className="text-stone-400">- TVA 5,5% (économie vs 20%)</span>
                    <strong className="text-green-400">- 7 975€</strong>
                  </div>
                  <div className="h-[1px] bg-stone-600 my-4"></div>
                ...
                <p className="text-stone-400 text-sm mt-6 mb-0">
            ...
            <div className="mt-12 text-center">
              ...
              <p className="text-sm text-stone-600 mt-4">EGB Occitanie monte vos dossiers d'aides (taux acceptation 95%)</p>
            </div>
          </div>
        </div>
      </section>
