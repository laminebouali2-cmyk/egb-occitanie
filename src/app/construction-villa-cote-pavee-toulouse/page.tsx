...
export const metadata: Metadata = {
  ...
  description:
    "Construction villa sur-mesure Côte Pavée Toulouse. Quartier résidentiel d'exception, terrains rares 550-750€/m². Architectes DPLG, finitions prestige. Clientèle CSP++. Devis gratuit 48h.",
  keywords: [
    "construction villa côte pavée toulouse",
    "terrain côte pavée toulouse",
    "architecte côte pavée",
    "maison prestige toulouse",
    "quartier résidentiel toulouse",
    "villa haut de gamme toulouse",
  ],
  openGraph: {
    title: "Construction Villa Côte Pavée | Quartier Premium Toulouse",
    description:
      "Villa sur-mesure quartier Côte Pavée. Terrains rares, architectes DPLG, finitions prestige. Devis gratuit.",
...
export default function ConstructionVillaCotePaveeToulouse() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative py-24 md:py-32 bg-gradient-to-br from-emerald-50 via-stone-50 to-stone-100">
          ...
          <div className="max-w-4xl">
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-emerald-200">
              <div>
                ...
                <div className="text-sm text-stone-600">Terrains/an disponibles</div>
              </div>
              <div>
                <div className="text-3xl font-light text-emerald-900 mb-2">68%</div>
                <div className="text-sm text-stone-600">Cadres supérieurs CSP+</div>
              </div>
              <div>
                <div className="text-3xl font-light text-emerald-900 mb-2">75k€</div>
                <div className="text-sm text-stone-600">Revenu médian foyer</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="prose prose-lg prose-stone max-w-none">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-10">
                <div className="bg-stone-50 p-6 border border-stone-200">
                  <h4 className="text-lg font-medium text-stone-900 mb-3">Profil socio-économique</h4>
                ...
                <div className="bg-stone-50 p-6 border border-stone-200">
                  <h4 className="text-lg font-medium text-stone-900 mb-3">Équipements & proximité</h4>
                  <ul className="text-sm text-stone-700 space-y-2">
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg prose-stone max-w-none">
              ...
              <div className="bg-gradient-to-r from-emerald-50 to-stone-50 border-2 border-emerald-200 p-8 rounded-lg mb-10">
                <h3 className="text-2xl font-medium text-emerald-900 mb-6">Budget total projet villa Côte Pavée</h3>

                <div className="space-y-6">
                  {/* Scenario 180m² */}
                  <div className="bg-white p-6 rounded border-2 border-stone-200">
                    <h4 className="text-xl font-semibold text-stone-900 mb-4">Villa 180m² - Finition Premium</h4>

                    <div className="space-y-3 mb-6">
                      <div className="flex justify-between pb-2 border-b border-stone-200">
                        <span className="text-stone-700">Terrain 900m² (650€/m² moyenne)</span>
                        <strong className="text-stone-900">585 000€</strong>
                      </div>
                      <div className="flex justify-between pb-2 border-b border-stone-200">
                        <span className="text-stone-700">Construction villa 180m² (3 400€/m²)</span>
                        <strong className="text-stone-900">612 000€</strong>
                      </div>
                      <div className="flex justify-between pb-2 border-b border-stone-200">
                        <span className="text-stone-700">Frais notaire terrain (2,5%)</span>
                        <strong className="text-stone-900">14 625€</strong>
                      </div>
                      <div className="flex justify-between pb-2 border-b border-stone-200">
                        <span className="text-stone-700">Aménagements extérieurs (terrasse, clôture, portail)</span>
                        <strong className="text-stone-900">45 000€</strong>
                      </div>
                      <div className="flex justify-between pb-2 border-b border-stone-200">
                        <span className="text-stone-700">Piscine 8×4m chauffée (optionnel)</span>
                        <strong className="text-stone-900">38 000€</strong>
                      </div>
                      <div className="h-[1px] bg-stone-300 my-4"></div>
                      <div className="flex justify-between text-xl">
                        <strong>BUDGET TOTAL (sans piscine):</strong>
                        <strong className="text-2xl text-emerald-800">1 256 625€</strong>
                      </div>
                      <div className="flex justify-between text-lg">
                        <span className="text-stone-600">Avec piscine:</span>
                        <strong className="text-emerald-800">1 294 625€</strong>
                      </div>
                    </div>

                    <div className="bg-stone-50 p-5 rounded">
                      <h5 className="font-semibold text-stone-900 mb-2">Construction 180m² inclut:</h5>
