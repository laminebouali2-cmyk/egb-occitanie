...
export const metadata: Metadata = {
 ...
 description:"Spécialiste rénovation maison toulousaine en brique rose depuis 15 ans. Rénovation complète, énergétique, façade. Prix détaillés, devis gratuit 48h, architectes DPLG partenaires. 200+ maisons rénovées à Toulouse.",
 keywords: ["rénovation maison toulouse","rénovation maison toulousaine","rénovation brique rose toulouse","rénovation complète maison toulouse","rénovation énergétique toulouse","entreprise rénovation toulouse","architecte rénovation toulouse","prix rénovation maison toulouse","rénovation maison ancienne toulouse","rénovation maison de maître toulouse",
 ],
 openGraph: {
 title:"Rénovation Maison Toulouse | Expert Maison Toulousaine",
 description:"Spécialiste rénovation maison toulousaine brique rose. 200+ rénovations, architectes DPLG, garanties décennale. Devis gratuit 48h.",
 url:"https://egb-occitanie.fr/renovation-maison-toulouse",
 },
};

const faqSchema = {"@context":"https://schema.org","@type":"FAQPage","mainEntity": [
 {"@type":"Question","name":"Quel est le prix d'une rénovation complète de maison à Toulouse ?","acceptedAnswer": {"@type":"Answer","text":"Le prix d'une rénovation complète à Toulouse varie entre 1 200€ et 2 500€/m² selon l'ampleur des travaux. Pour une maison toulousaine de 120m², comptez 144 000€ à 300 000€. Rénovation légère (peinture, sols, cuisine, SdB): 1 200-1 500€/m². Rénovation complète (structure, isolation, électricité, plomberie, finitions): 1 800-2 500€/m². Restauration patrimoine (maison de maître, conservation éléments): 2 200-3 000€/m²."
 }
 },
 {"@type":"Question","name":"Comment rénover une maison toulousaine en brique rose ?","acceptedAnswer": {"@type":"Answer","text":"La rénovation d'une maison toulousaine en brique rose nécessite une expertise spécifique. Conservation des murs en brique rose apparente (nettoyage par micro-gommage, rejointoiement à la chaux). Isolation par l'intérieur pour préserver la façade (12-14cm laine de bois). Respect du PLU centre historique si applicable. Toiture: conservation tuiles canal traditionnelles. EGB Occitanie a rénové 80+ maisons toulousaines traditionnelles avec conservation du patrimoine architectural."
 }
 },
 {"@type":"Question","name":"Faut-il un permis pour rénover une maison à Toulouse ?","acceptedAnswer": {"@type":"Answer","text":"Le permis de construire n'est pas nécessaire pour rénovation intérieure sans modification façade ni structure. Déclaration préalable obligatoire si: modification aspect extérieur (fenêtres, couleur façade, toiture), création ouvertures, extension <20m². Permis de construire obligatoire si: extension >20m², surélévation, modification structure porteuse, zone ABF (Architecte des Bâtiments de France) comme hypercentre Toulouse. EGB Occitanie gère l'ensemble des démarches administratives."
 }
 },
 {"@type":"Question","name":"Combien de temps pour rénover une maison à Toulouse ?","acceptedAnswer": {"@type":"Answer","text":"Durée rénovation maison Toulouse selon ampleur: Rénovation légère (peinture, sols, cuisine): 2-3 mois. Rénovation complète sans gros œuvre: 4-6 mois. Rénovation lourde avec structure: 6-9 mois. Restauration maison de maître: 9-12 mois. EGB Occitanie garantit les délais contractuels avec 0 retard sur nos chantiers de rénovation ces 5 dernières années."
 }
 },
 {"@type":"Question","name":"Quelles aides pour rénover une maison à Toulouse en 2025 ?","acceptedAnswer": {"@type":"Answer","text":"Aides disponibles rénovation énergétique Toulouse 2025: MaPrimeRénov' (jusqu'à 20 000€ selon revenus), MaPrimeRénov' Sérénité (50% coût travaux, plafond 35 000€ ménages modestes), Éco-PTZ (prêt 0% jusqu'à 50 000€), CEE Certificats Économie Énergie (primes énergies), TVA 5,5% sur travaux rénovation énergétique, Exonération taxe foncière possible (2 ans). EGB Occitanie vous accompagne dans montage dossiers aides (service inclus)."
 }
 }
 ]
};
...
export default function RenovationMaisonToulouse() {
 ...
 <strong className="font-medium text-gray-900"> 200+ maisons rénovées. Devis gratuit sous 48h.</strong>
 </p>
 ...
 <div className="text-sm text-gray-600">Maisons rénovées</div>
 </div>
 <div>
 <div className="text-3xl font-light text-gray-900 mb-2">80+</div>
 <div className="text-sm text-gray-600">Maisons toulousaines brique</div>
 </div>
 <div>
 <div className="text-3xl font-light text-gray-900 mb-2">0</div>
 <div className="text-sm text-gray-600">Retard de chantier</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-lg font-semibold text-gray-900 mb-3">Rénovation vs Déménagement : Le calcul</h3>
 ...
 <svg className="w-6 h-6 text-gray-900 mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
 </svg>
 <span className="text-gray-700"><strong>Économie 200 000€ à 300 000€</strong> vs achat équivalent (prix + notaire + travaux finitions)</span>
 </li>
 <li className="flex items-start gap-3">
 <svg className="w-6 h-6 text-gray-900 mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
 </svg>
 <span className="text-gray-700"><strong>Emplacement préservé</strong> : centre-ville, proximité écoles/commerces, quartier que vous connaissez</span>
 </li>
 <li className="flex items-start gap-3">
 <svg className="w-6 h-6 text-gray-900 mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
 </svg>
 <span className="text-gray-700"><strong>Charme architectural unique</strong> : brique rose, volumes anciens, hauteur sous plafond (2,80m-3,20m vs 2,50m neuf)</span>
 </li>
 <li className="flex items-start gap-3">
 <svg className="w-6 h-6 text-gray-900 mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
 </svg>
 <span className="text-gray-700"><strong>Jardin mature</strong> : arbres de 30-50 ans, végétation établie (vs terrain nu en construction)</span>
 </li>
 <li className="flex items-start gap-3">
 <svg className="w-6 h-6 text-gray-900 mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
 </svg>
 <span className="text-gray-700"><strong>Valorisation patrimoniale</strong> : maison rénovée = +35% valeur vs avant travaux (source SeLoger 2024)</span>
 </li>
 <li className="flex items-start gap-3">
 <svg className="w-6 h-6 text-gray-900 mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
 </svg>
 <span className="text-gray-700"><strong>Aides rénovation énergétique</strong> : MaPrimeRénov' jusqu'à 20 000€, Éco-PTZ 50 000€, TVA 5,5%</span>
 </li>
 <li className="flex items-start gap-3">
 <svg className="w-6 h-6 text-gray-900 mt-1 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
 </svg>
 <span className="text-gray-700"><strong>Pas de déménagement stressant</strong> : rénovation par zone, possibilité de rester sur place selon projet</span>
 </li>
 </ul>
 </div>
 </div>
 ...
 <h3 className="text-2xl font-light text-gray-900 mt-10 mb-6">
 ...
 <th className="py-4 px-4 text-gray-900 font-semibold">Type de rénovation</th>
 <th className="py-4 px-4 text-gray-900 font-semibold">Prix / m²</th>
 <th className="py-4 px-4 text-gray-900 font-semibold">Travaux inclus</th>
 </tr>
 </thead>
 ...
 <div className="text-sm uppercase tracking-wider text-gray-500 mb-3">Maison 80m²</div>
 <div className="space-y-3 text-sm">
 <div className="flex justify-between pb-2 border-b border-gray-100">
 <span className="text-gray-600">Légère</span>
 <strong className="text-gray-900">96 000€</strong>
 </div>
 <div className="flex justify-between pb-2 border-b border-gray-100">
 <span className="text-gray-600">Complète</span>
 <strong className="text-gray-900">160 000€</strong>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-600">Lourde</span>
 <strong className="text-gray-900">200 000€</strong>
 </div>
 </div>
 </div>

 <div className="bg-gray-900 p-6 border border-gray-900 text-white">
 <div className="text-sm uppercase tracking-wider text-gray-400 mb-3">Maison 120m²</div>
 <div className="space-y-3 text-sm">
 <div className="flex justify-between pb-2 border-b border-gray-700">
 <span className="text-gray-300">Légère</span>
 <strong className="text-white">168 000€</strong>
 </div>
 <div className="flex justify-between pb-2 border-b border-gray-700">
 <span className="text-gray-300">Complète</span>
 <strong className="text-white">240 000€</strong>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-300">Lourde</span>
 ...
 <div className="bg-white p-6 border border-gray-200">
 <div className="text-sm uppercase tracking-wider text-gray-500 mb-3">Maison 180m²</div>
 <div className="space-y-3 text-sm">
 <div className="flex justify-between pb-2 border-b border-gray-100">
 <span className="text-gray-600">Légère</span>
 <strong className="text-gray-900">252 000€</strong>
 </div>
 <div className="flex justify-between pb-2 border-b border-gray-100">
 <span className="text-gray-600">Complète</span>
 <strong className="text-gray-900">360 000€</strong>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-600">Lourde</span>
 <strong className="text-gray-900">450 000€</strong>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="bg-white border border-gray-200 divide-y divide-gray-200 mb-8">
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Démolition et évacuation gravats</div>
 <div className="text-sm text-gray-600">Dépose cuisine/SdB, cloisons, revêtements sols</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">40 - 80€ /m²</div>
 </div>
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Électricité complète aux normes</div>
 <div className="text-sm text-gray-600">Tableau, câblage, prises, éclairages, protection</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">120 - 180€ /m²</div>
 </div>
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Plomberie et chauffage</div>
 <div className="text-sm text-gray-600">Tuyauterie, radiateurs, chaudière, sanitaires</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">100 - 160€ /m²</div>
 </div>
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Isolation thermique</div>
 <div className="text-sm text-gray-600">Combles (300mm laine soufflée), murs intérieur, plancher</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">80 - 140€ /m²</div>
 </div>
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Doublage cloisons et placo</div>
 <div className="text-sm text-gray-600">Plaques plâtre BA13, isolation, bandes, enduit</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">50 - 70€ /m²</div>
 </div>
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Menuiseries extérieures</div>
 <div className="text-sm text-gray-600">Fenêtres PVC/alu double vitrage, portes-fenêtres</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">400 - 800€ /unité</div>
 </div>
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Sols (carrelage grès cérame)</div>
 <div className="text-sm text-gray-600">Fourniture, pose, ragréage préalable</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">70 - 120€ /m²</div>
 </div>
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Parquet contrecollé chêne</div>
 <div className="text-sm text-gray-600">Parquet 14mm épaisseur, pose flottante</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">60 - 100€ /m²</div>
 </div>
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Peinture complète</div>
 <div className="text-sm text-gray-600">2 couches murs, 1 couche plafond, lessivable</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">25 - 40€ /m²</div>
 </div>
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Cuisine équipée premium</div>
 <div className="text-sm text-gray-600">Meubles, plan travail, électroménager, robinetterie</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">8 000 - 18 000€</div>
 </div>
 <div className="p-5 flex justify-between items-center">
 <div>
 <div className="font-medium text-gray-900 mb-1">Salle de bain complète</div>
 <div className="text-sm text-gray-600">Douche italienne, meuble vasque, WC, faïence, plomberie</div>
 </div>
 <div className="text-gray-900 font-semibold whitespace-nowrap ml-4">6 000 - 12 000€</div>
 </div>
 </div>
 ...
 <h4 className="text-lg font-medium text-gray-900 mb-3">Architecture typique</h4>
 ...
 <div className="bg-gray-50 p-6 border border-gray-200">
 <h4 className="text-lg font-medium text-gray-900 mb-3">Problématiques courantes</h4>
 <ul className="text-sm text-gray-700 space-y-2">
 ...
 <h4 className="text-lg font-medium text-gray-900 mb-3 flex items-center gap-3">
 <span className="flex-shrink-0 w-8 h-8 rounded-full bg-gray-900 text-white flex items-center justify-center text-sm font-semibold">1</span>
 ...
 <div className="bg-white border border-gray-200 p-6">
 <h4 className="text-lg font-medium text-gray-900 mb-3 flex items-center gap-3">
 <span className="flex-shrink-0 w-8 h-8 rounded-full bg-gray-900 text-white flex items-center justify-center text-sm font-semibold">2</span>
 ...
 <div className="bg-white border border-gray-200 p-6">
 <h4 className="text-lg font-medium text-gray-900 mb-3 flex items-center gap-3">
 <span className="flex-shrink-0 w-8 h-8 rounded-full bg-gray-900 text-white flex items-center justify-center text-sm font-semibold">3</span>
 ...
 <div className="bg-white border border-gray-200 p-6">
 <h4 className="text-lg font-medium text-gray-900 mb-3 flex items-center gap-3">
 <span className="flex-shrink-0 w-8 h-8 rounded-full bg-gray-900 text-white flex items-center justify-center text-sm font-semibold">4</span>
 ...
 <div className="bg-gray-900 text-white p-8 rounded-sm mb-8">
 <h3 className="text-2xl font-light mb-4">Études de cas : Maison toulousaine rénovée à Saint-Cyprien</h3>
 <div className="grid md:grid-cols-2 gap-8 mb-6">
 <div>
 <div className="text-sm text-gray-400 uppercase tracking-wider mb-2">Avant rénovation</div>
 ...
 <div>
 <div className="text-sm text-gray-400 uppercase tracking-wider mb-2">Après rénovation (6 mois)</div>
 <ul className="text-gray-300 space-y-2 text-sm">
 ...
 <div className="border-t border-gray-700 pt-6 grid md:grid-cols-3 gap-4 text-center">
 <div>
 <div className="text-3xl font-light mb-1">248 000€</div>
 <div className="text-sm text-gray-400">Budget rénovation complète</div>
 </div>
 <div>
 <div className="text-3xl font-light mb-1">22 000€</div>
 <div className="text-sm text-gray-400">Aides MaPrimeRénov' + CEE</div>
 </div>
 <div>
 <div className="text-3xl font-light mb-1">6 mois</div>
 <div className="text-sm text-gray-400">Durée chantier (dans délais)</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="text-5xl font-light text-gray-300">{step.number}</div>
 </div>
 ...
 <div className="mt-12 bg-gray-900 text-white p-8 rounded-sm">
 ...
 <div className="text-gray-400">Rénovation complète 100-150m²</div>
 </div>
 <div>
 <div className="text-4xl font-light mb-2">6-9 mois</div>
 <div className="text-gray-400">Rénovation lourde avec structure</div>
 </div>
 <div>
 <div className="text-4xl font-light mb-2">0</div>
 <div className="text-gray-400">Retard de chantier (garantie)</div>
 </div>
 </div>
 </div>
 </div>
 ...
 <details key={index} className="group border border-gray-200 bg-gray-50">
 <summary className="px-6 py-5 cursor-pointer flex items-center justify-between text-gray-900 font-medium text-lg hover:bg-gray-100 transition-colors">
 {faq.question}
 <svg className="w-5 h-5 text-gray-500 transition-transform group-open:rotate-180" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
 ...
 <a
 href="tel:+33665015882"
 className="inline-flex items-center justify-center gap-2 bg-gray-900 text-white px-6 py-3 text-base font-medium hover:bg-gray-800 transition-colors"
 >
 <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
 </svg>
 ...
 <Link
 href="/contact"
 className="inline-flex items-center justify-center gap-2 border border-gray-300 text-gray-700 px-6 py-3 text-base font-medium hover:border-gray-400 hover:text-gray-900 transition-colors"
 >
 ...
 <Link
 href="/contact"
 className="inline-flex items-center gap-3 bg-white text-gray-900 px-8 py-4 text-base font-medium hover:bg-gray-100 transition-all duration-300"
 >
 ...
 className="group bg-white p-6 border border-gray-200 hover:border-gray-400 transition-all"
 >
 ...
 <span className="inline-flex items-center gap-2 text-gray-500 text-sm group-hover:gap-3 transition-all">
 En savoir plus
 <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
 <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
 </svg>
