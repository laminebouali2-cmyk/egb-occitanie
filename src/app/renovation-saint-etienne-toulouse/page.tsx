...
export default function RenovationSaintEtienneToulouse() {
 ...
 <div className="text-3xl font-bold mb-2 text-gray-900">5 538€</div>
 <div className="text-gray-600">Prix m² #1 Toulouse</div>
 </div>
 <div className="bg-white border-2 rounded-lg p-6 border border-gray-200">
 <div className="text-3xl font-bold mb-2 text-gray-900">17e-19e</div>
 <div className="text-gray-600">Hôtels particuliers siècles</div>
 </div>
 <div className="bg-white border-2 rounded-lg p-6 border border-gray-200">
 <div className="text-3xl font-bold mb-2 text-gray-900">ABF Strict</div>
 <div className="text-gray-600">Secteur protégé Cathédrale</div>
 </div>
 <div className="bg-white border-2 rounded-lg p-6 border border-gray-200">
 <div className="text-3xl font-bold mb-2 text-gray-900">Malraux</div>
 <div className="text-gray-600">30% réduction IR éligible</div>
 </div>
 </div>
 </div>
 </div>
