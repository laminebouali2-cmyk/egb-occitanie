  ...
  return (
    <section className="py-16 lg:py-32">
      <div className="mx-auto w-full max-w-6xl px-5 lg:px-8">
        ...
        <motion.div
          ref={ref}
          className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8 lg:mb-14"
        ...
        <div className="flex gap-3.5 overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-hide lg:hidden -mx-5 px-5">
          {featured.map((review, i) => (
            <motion.div
              ...
              className="w-[78vw] shrink-0 snap-start rounded-xl border border-border bg-white p-5"
            >
              <StarRating rating={review.rating} size={12} />
              <blockquote className="mt-3 text-[13px] text-text-secondary leading-relaxed line-clamp-3">
        ...
        <div className="hidden lg:grid grid-cols-3 gap-5">
          {featured.map((review, i) => (
            ...
            >
              ...
              <blockquote className="mt-4 text-sm text-text-secondary leading-relaxed line-clamp-4">
                &ldquo;{review.text}&rdquo;
              </blockquote>
